...
describe('Convert Word in Number', () => {
  ...
  it('a soma de todos os caracteres permitidos deve ser 1378', () => {
    const allowedCharacteres = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';
    expect(convertWordToNumbers(allowedCharacteres)).toBe(1378);
  });
});
